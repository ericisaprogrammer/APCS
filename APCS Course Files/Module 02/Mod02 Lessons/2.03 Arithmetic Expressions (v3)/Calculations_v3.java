...
public class Calculations_v3
{
    public static void main(String[ ] args)
    {
        ...
        System.out.print("16 - " + iNum2 + " - " + iNum1 + " = ");
        System.out.println(16 - iNum2 - iNum1);
        System.out.println("3.14 - 5 = " + (3.14 - 5.0));
        System.out.println();
        ...
        System.out.print(iNum1 + " * " + iNum2 + " = ");
        System.out.println(iNum1 * iNum2);
        System.out.println("3.14 * 5 * 5 = " + (3.14 * 5.0 * 5.0));
        System.out.println();
        ...
        /**
         * Note: Since the variables are both integer types, there 
         * are no decimals available, so the number will be 0, even though
         * the answer is .36.
         */
        System.out.println(iNum2 / iNum1);
        System.out.println("43.21 / 5 = " + (43.21 / 5.0));
        System.out.println();
          
        // Modulus operator
        System.out.println("Modulus");
        System.out.print("16 % " + iNum2 + " = ");
        System.out.println(16 % iNum2);
        System.out.println("5 % 3.14 = " + (5.0 % 3.14));
        System.out.println();
