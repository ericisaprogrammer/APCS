...
public class CurrencyConversionV1
{
    public static void main(String [ ] args)
    {
        ...
        double pesoExchangeRate = 16.88987;     // local variable for exchange rate of US Dollars to Pesos
        ...
        double yenExchangeRate = 119.2730;      // local variable for exchange rate of US Dollars to Yen
        ...
        double euroExchangeRate = 0.897763;     // local variable for exchange rate of US Dollars to Euro
